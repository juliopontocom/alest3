...
1. Re-implemente o algoritmo de implementação de matrizes, agora sobre duas sequências de bits representados como Strings de 0 e 1. Use a assinatura abaixo:
